...
```{r ascombe data}
anscombe_quartet = readRDS("../ldap_wk5/data/anscombe_quartet.rds")
...
datasaurus_dozen <- readRDS("../ldap_wk5/data/datasaurus_dozen.rds")
...
# save the plot 
file_path <- "../output/datasuraus_dozen.png"
ggsave(filename = file_path, "datasuraus_dozen.png", width = 20, height = 20, units = "cm")
  # this don't work but just ignore this for now
```
